...
ActiveRecord::Schema.define(version: 20_200_408_081_941) do
  ...
  create_table 'following_relationships', force: :cascade do |t|
    ...
    t.index ['followed_user_id'],
            name: 'index_following_relationships_on_followed_user_id'
    t.index %w[follower_id followed_user_id], name: 'relationship_index', unique: true
  ...
  create_table 'likes', force: :cascade do |t|
    ...
    t.index %w[user_id shout_id],
            name: 'index_likes_on_user_id_and_shout_id',
            unique: true
  ...
  create_table 'shouts', force: :cascade do |t|
    ...
    t.index %w[content_type content_id],
            name: 'index_shouts_on_content_type_and_content_id'
